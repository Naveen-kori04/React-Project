...
const Navbar = ({ theme, setTheme }) => {
    ...
    return (
        <section id="home">
        <div className='flex justify-between items-center px-4 sm:px-12 1g:px-24 xl:px-40 py-4 sticky top-0 z-20
            ...
            <div className={`text-gray-700 dark:text-white sm:text-sm ${!sidebarOpen ? 'max-sm:w-0 overflow-hidden' : 'max-sm:w-60 max-sm:pl-10'}
                             max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen max-sm:h-full max-sm:flex-col max-sm:bg-primary max-sm:text-white 
            ...
            <div className='flex items-center gap 2 sm:gap-4'>
                ...
                text-white px-6 py-2 rounded-full cursor-pointer hover:scale-103
                 transition-all'>
