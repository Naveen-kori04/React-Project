...
const Teams = () => {
  return (
    ...
    xl:px-40 pt-30 text-gray-800 dark:text-white'>
      ...
      <Title
        title='Meet the team'
        description='A group of passionate professionals dedicated to delivering exceptional results.'
      />
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5'>
        ...
        {teamData.map((teamMember, index) => (
          <div
            ...
            dark:shadow-white/5 hover:scale-105 transition-all duration-300'
          >
            <img
            ...
            <div className='flex-1'>
              <h3 className='text-sm font-bold'>{teamMember.name}</h3>
              <p className='text-xs opacity-60'>{teamMember.title}</p>
            </div>
